...
public class Volunteer : User
{
    ...
    public Volunteer(string name, string surname, Gender gender, DateOnly dateOfBirth, string phoneNumber,
        string emailAddress, string password, Role role, string address, bool isDeleted, string comment,
    ...
    public Volunteer(long id, string name, string surname, Gender gender, DateOnly dateOfBirth, string phoneNumber,
        string emailAddress, string password, Role role, string address, bool isDeleted, string comment,
        VolunteerStatus status)
